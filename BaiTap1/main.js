...
const products = [
    ...
    new Product(3, 'Wireless Earbuds', 5000000, 10, 'Accessories', true),
    new Product(4, 'Phone Case', 500000, 20, 'Accessories', true),
    new Product(5, 'Screen Protector', 300000, 0, 'Accessories', false),
    new Product(6, 'Monitor LG 4K', 12000000, 2, 'Electronics', true), 
];
// cau 3
